...
describe Nostr do
  describe "module functions" do
    ...
    it "validates an object's class" do
      expect(Nostr.typecheck(1, Integer)).must_equal 1
      expect { Nostr.typecheck(1, String) }.must_raise TypeError
    end
    ...
    it "validates string class and length" do
      ...
      expect(Nostr.string(str, 4)).must_equal str
      expect { Nostr.string(str, 5) }.must_raise Nostr::SizeError
    ...
    it "validates a binary string" do
      ...
      expect { Nostr.binary("010203") }.must_raise Nostr::EncodingError
      expect { Nostr.binary("\x00\x01\x02") }.must_raise Nostr::EncodingError
    end
    ...
    it "validates a hex string" do
      ...
      expect { Nostr.hex("0123".b) }.must_raise Nostr::EncodingError
    end
  end
end
